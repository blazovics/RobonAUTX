...
void RemoteDisplayManager::SkillRaceInitiated()
{

}

void RemoteDisplayManager::SpeedRaceInitiated()
{

}

void RemoteDisplayManager::StartTimer()
{

}

void RemoteDisplayManager::SetTimerValue(quint32 value)
{
